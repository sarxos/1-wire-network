...
@XStreamAlias("device28")
public class Device28 extends AbstractDevice implements TemperatureDevice,
RemoteTemperatureDevice{

	private static final long serialVersionUID = 9144423965298685435L;
	
	public static final double RESOLUTION_A = 0.5;		// 94 ms delay
	public static final double RESOLUTION_B = 0.25;		// 188 ms delay
	public static final double RESOLUTION_C = 0.125;	// 375 ms delay
	public static final double RESOLUTION_D = 0.0625;	// 750 ms delay
	...
	public Device28(OneWireContainer28 owc) throws RemoteException {
		super(owc);
	...
	public double measTemperature() {
		try {
			OneWireContainer28 c = (OneWireContainer28) getContainer();
